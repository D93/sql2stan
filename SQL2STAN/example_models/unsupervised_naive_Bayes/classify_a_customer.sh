...
echo "(example context: unsupervised naive Bayes for classifying sports shop customers)"
printf '\n\n'

read -p "Where is your trained classifier? Enter a database name (without special characters, and for the case sensitivity also double-quoted, e.g. \"unsupervisedNaiveBayes\"): " dbname_entered 
